...
> **Architecture de travail validée (2026-09-10, mise à jour 2026-09-12).** PASS 1 Header / Home / Footer est **implémentée et validée visuellement** (desktop + mobile). L’ordre Home actuel est : Header · Hero campagne · Sélection (si disponible) · Déclaration · Entrée boutique · Footer. BRAND-MATERIAL / BRAND-SKATE reste différé jusqu’à un vrai actif approuvé. Aucun placeholder graphique public artificiel. Hero desktop : asset horizontal dédié. Hero mobile : asset portrait dédié. Le mobile fait partie de **chaque** pass (zones tactiles ≥ 44 px, tests 320 / 375 / 390–430 px et tablette). L’ordre §5 ci-dessous reste l’architecture spec d’origine ; il ne remplace pas cette architecture de travail.
