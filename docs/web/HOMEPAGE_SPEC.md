...
> **Architecture de travail validée (2026-09-10).** Pour le redesign storefront (PASS 1 **non encore implémentée**), l’ordre Home retenu est : Header · Hero campagne · Interlude Ligne · Sélection · **un seul** grand moment visuel éditorial (matière et/ou skate, pas deux bandes) · Déclaration · Entrée boutique · Footer. Le mobile fait partie de **chaque** pass (Header compact, Hero copy-first puis visuel après le CTA, typo adaptée, zones tactiles ≥ 44 px, tests 320 / 375 / 390–430 px et tablette). L’ordre §5 ci-dessous reste l’architecture spec d’origine ; il ne remplace pas cette architecture de travail.
